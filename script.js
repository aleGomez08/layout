...
function arrastrarElemento(element) {
    ...
    function pararArrastreElemento(e) {
        document.onpointerup = null;
        document.onpointermove = null;
    }
    function dobleClicparaTraerEnFrente(e){
        element.ondblclick = dobleClicparaTraerEnFrente;
        console.log(e);
        document.ondblclick = dobleClicparaTraerEnFrente;
